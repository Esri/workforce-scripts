...
"""
   ...
   This sample logs incomplete assignments with a corresponding survey / collector feature
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser("Report incomplete assignments with completed work orders")
    ...
    parser.add_argument('-field-name', dest='field_name', default="work_order_id",
                        help="The field name within the Survey or Collector Layer you use to integrate with Workforce. "
                             "Use actual field name, not alias. Default is work_order_id")
    parser.add_argument('--cancel-assignments', action='store_true', default=False,
                        help="If provided, cancel the assignments returned without an associated survey if they have not been started or completed")
